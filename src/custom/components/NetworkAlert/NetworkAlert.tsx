...
const BG_COLORS_BY_DARK_MODE_AND_CHAIN_ID: {
  ...
  dark: {
    ...
    [SupportedChainId.GNOSIS_CHAIN]:
      'radial-gradient(285% 8200% at 30% 50%, rgba(0, 129, 90, 0.1) 0%, rgba(219, 255, 0, 0) 100%),radial-gradient(75% 75% at 0% 0%, rgba(150, 190, 220, 0.05) 0%, rgba(0, 129, 90, 0.1) 100%), hsla(0, 0%, 100%, 0.05)',
  },
  light: {
    [SupportedChainId.POLYGON]:
...
const TEXT_COLORS: { [chainId in NetworkAlertChains]: string } = {
  ...
  [SupportedChainId.GNOSIS_CHAIN]: '#00d897',
}
