...
export default function Menu() {
  const { helpCenterUrl, infoLink, discordUrl, docs } = CHAIN_INFO[SupportedChainId.GNOSIS_CHAIN]
          ...
          (() => {
            switch (menu) {
              ...
              default:
                return (
                  <MenuFlyout>
                    <MenuItem href={infoLink ?? 'https://uniswap.org/'}>
                      <div>
                        <Trans>About</Trans>
                      </div>
                      <Info opacity={0.6} size={16} />
                    </MenuItem>
                    <MenuItem href={helpCenterUrl ?? 'https://help.uniswap.org/'}>
                      <div>
                    ...
                    <MenuItem href={discordUrl ?? 'https://discord.gg/FCfyBSbCU5'}>
                      <div>
                        <Trans>Discord</Trans>
                      </div>
                    ...
                    <MenuItem href={docs ?? 'https://docs.uniswap.org/'}>
                      <div>
                        <Trans>Docs</Trans>
                      </div>
